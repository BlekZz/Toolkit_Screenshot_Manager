...
> **狀態（2026-07-11 更新）**：MVP 1.0 已實作完成，並經程式碼逐項驗收比對。§14 驗收標準 12 條中 11 條完全達成，殘餘缺口移列 MVP2（見 [[Sprint_Screenshot_Triage_MVP2]]）。
...
> MVP2 規劃見 [[Sprint_Screenshot_Triage_MVP2]]。以下候選功能於 MVP1 期間均未推進。
